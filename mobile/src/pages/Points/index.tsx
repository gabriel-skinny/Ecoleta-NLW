...
const Points = () => {
  ...
  const routesParms = routes.params as Params
    ...
    useEffect(() => {
      async function loadPosition(){
        ...
        if (status !== "granted"){
          Alert.alert("Opps", "Precisamos de sua permisão para obter a localização")
          return
        }
    ...
    <>
      <View style={styles.container}>
        ...
        <MapView 
          ...
          >
          {points.map(point => (
          <Marker onPress={() => handleNavigateToDetail(point.id)} 
            key={String(point.id)}
